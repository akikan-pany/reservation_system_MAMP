<?php
    ...
    echo "<hr><a href=\"menu_message4.php\">メニュー</a><br><a href=\"login.html\">ログアウト</a><hr>";
...
for ( $day = 1; $day <= $day_count; $day++, $youbi++) {
    ...
    if ($today == $date) {
        ...
        $week .= '<td class="today">' . $day;
            $week .= '<form action="show_message4.php" method="POST">';
            $week .= '<br><input type="hidden" name="day"';
            $week .= '" value="';
            $week .=  $day;
            $week .= '">';
            $week .= '<input type="hidden" name="month" value="';
            $week .= $ym;
            $week .= '">';
            $week .= '<input type="submit" value="確認" />';
            $week .= '</form>';
    } else {
        $week .= '<td>' . $day;
            $week .= '<form action="show_message4.php" method="POST">';
